 ...
 *
 * Callers are responsible for canonicalizing the input first; passing arbitrary
 * encoder output will produce a CID that is not reproducible by other clients.
 */

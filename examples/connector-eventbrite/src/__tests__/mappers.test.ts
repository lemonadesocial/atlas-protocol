...
import { eventbriteEventToAtlas, eventbriteTicketClassToAtlas } from "../mappers.js";
...
describe("eventbriteEventToAtlas", () => {
  ...
  it("maps an online event to OnlineEventAttendanceMode and VirtualLocation", () => {
    ...
    expect(atlas["atlas:purchase_endpoint"]).toBe("https://atlas.example.com/events/99/purchase");
  });
